...
func main() {
	...
	deviceConfig := malgo.NewDeviceConfig(malgo.Playback)
	...
	deviceConfig.DataCallback = func(_ malgo.Device, output, _ *malgo.DataBuffer, framecount int) {
		io.ReadFull(reader, output.Bytes())
	}
